        ...
        <footer className="bg-primary px-10 lg:px-[80px] py-5 flex flex-col">
            <div className="flex flex-col items-start lg:flex-row lg:justify-between">
                <div className="flex flex-col">
                    <h5 className="text-xl sm:text-h5 font-semibold text-accent">Get in Touch </h5>
                    ...
                    {socmedItems.map((item, index) => (
                        <Link href={item.link} key={index}>
                            <div className="flex flex-row gap-2">
                                ...
                                <div>
                                    <h6 className="text-sm sm:text-h6 text-accent">{item.socmed}</h6>
                ...
                <div className="flex flex-col mt-5 lg:mt-0">
                    ...
                    <div className="flex flex-col lg:flex-row text-accent mt-1 gap-x-4 text-xs sm:text-base">
