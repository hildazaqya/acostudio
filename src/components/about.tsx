    ...
    return (
        <section className="w-full p-10 lg:px-[80px] py-5 flex flex-col justify-center">
            ...
            <div className="flex lg:flex-row justify-around mt-7 w-full mx-auto">
                <div className="flex flex-col lg:flex-row w-[-webkit-fill-available] justify-around gap-3 lg:gap-0">
                    <div className="flex flex-row">
                    <Image src="./logo.svg" alt="Logo" width={100} height={100} className="shadow-logo" />
                    <div className="flex flex-col text-left justify-center max-w-[500px]">
